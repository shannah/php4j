...
public class XAMPPLinuxBuilder {
    ...
    private final File destDir = new File("dist/php4j-linux");
    public void execute() throws IOException {
        
        if (!xamppPath.exists()) {
            throw new IOException("Building PHP4J requires XAMPP to be installed.  Please download and install it first https://www.apachefriends.org/download.html");
        }
